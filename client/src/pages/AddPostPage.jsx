...
import { createPost } from '../redux/auth/features/post/postSlice'
  ...
  return (
    <form className='w-1/3 mx-auto py-10' onSubmit={(e) => e.preventDefault()}>
      ...
      <div className='flex gap-8 items-center justify-center mt-4'>
        ...
        className='flex items-center bg-gray-600 text-xs text-white rounded-sm py-2 px-4'>Добавить пост</button>
